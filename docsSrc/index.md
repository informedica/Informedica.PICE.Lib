...
GenBuild is a template library that serves as a scaffold to create 
libraries and applications heavily influenced and based upon MiniScaffold.  

## Why use GenBuild?

GenBuild is used as a starting point for Informedica libraries and applications.
It serves as a starting point for a complete setup for Informedica 
...
<div class="row row-cols-1 row-cols-md-2">
  ...
  <div class="col">
    <div class="card h-100">
      ...
      <div class="card-footer text-right   border-top-0">
        <a href="{{siteBaseUrl}}/Api_Reference/GenBuild/GenBuild.html" class="btn btn-primary">Read Api Docs</a>
      </div>
    </div>
  </div>
</div>
